...
// 내부적으로 생성자, getter, setter , ToString 기본적으로 만들어지고
...
fun main(){
    ...
    var bookVO = BookVO("자바야놀자","홍길동","이지즈",15000)
    bookVO.title="오라클"
    ...
    var bookVO1 = BookVO("성춘향","제이쿼리","이지즈",12000)
        println(UserVO("장보고","010-222-1111").toString())
