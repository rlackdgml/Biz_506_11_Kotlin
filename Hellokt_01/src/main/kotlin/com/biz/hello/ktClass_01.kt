...
/**
 * Kotilin에서의 클래스
 * Kotilin에서는 필드변수(속성, 인스턴스변수)를 생성자와 함께
 * 선언하고 초기화 할 수 있다*
 */
...
// 속성에 기본(default)값을 지정하여 객체를 만들떄
// 변수값이 주입되지 않으면 기본값으로 변수를 초기화
// var obj = Class_03("이몽룡",33) : name 속성과 age를 정의
// var onj = Class_03() : name은 홍길동, age는 0으로 초기화 된다.
 class Class_03(val name : String="홍길동", val age : Int = 0){}
